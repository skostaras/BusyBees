...
public class ViewResults extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("					<p>");
		out.println("						Το Busy Bees είναι ένα project που δημιουργήθηκε από την παραπάνω");
		out.println("						ομάδα στο πλαίσιο του 2nd Coding Bootcamp (<a");
		out.println("							href='http://www.afdemp.org/bootcamp/' target='blank'>Alliance");
		...
		out.println("							class='fa fa-twitter'></i></a> <a><i class='fa fa-linkedin'></i></a>");
		out.println("					</p>");
		out.println("				</div>");
		out.println("				<div class='col-lg-4'>");
