...
public class SearchByFilterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String givenSubcategory = null; // To parakato switch to kano epeidi ta sigkekrimena fields stin forma einai
										// hidden me javascript kai an den paro times apo ola ta hidden fields, tote
		...
		try {
			resultlist = pjobdao.findByFilter(givenCategory, givenSubcategory, givenCity, givenType, givenPhone,
					givenwebpage, givenMinMoney, givenMaxMoney);
