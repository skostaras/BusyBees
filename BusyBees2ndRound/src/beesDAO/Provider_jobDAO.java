...
public class Provider_jobDAO {
	...
	public void saveProvider_job(Provider_job provider_job, int providerid) throws Exception {
		...
		String sqlquery = "INSERT INTO provider_job (idprovider, workemail, firstName, lastName, phone, webpage, street, pc, city, description, price, `type`, category, subcategory, service) VALUES ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
	...
	public ArrayList<Provider_job> findProviderDetails(String searchTerm) throws Exception {
		...
		try {
			...
			while (rs.next()) {
				...
				results.add(new Provider_job(rs.getString("workemail"), rs.getString("firstName"),
						rs.getString("lastName"), rs.getString("phone"), rs.getString("webpage"),
						rs.getString("street"), rs.getString("pc"), rs.getString("city"), rs.getString("description"),
						rs.getString("price"), rs.getString("type"), rs.getString("category"),
						rs.getString("subcategory"), rs.getString("service")));
	...
	public ArrayList<Provider_job> findByFilter(String givenCategory, String givenSubcategory, String givenCity,
			String givenType, String givenPhone, String givenwebpage, int givenMinMoney, int givenMaxMoney)
			throws Exception {
