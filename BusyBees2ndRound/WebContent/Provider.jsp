...
<div class="col-lg-3">
        ...
        <br>
            ...
            <li><a href=".teachersform" class="btn hoverbutton" role="tab" data-toggle="tab">Εκπαιδευτικός</a></li>
            <li><a href=".workersform" class="btn hoverbutton"  role="tab" data-toggle="tab">Μάστορας</a></li>
            <li><a href=".programmersform" class="btn hoverbutton" role="tab" data-toggle="tab">Κομπιουτεράς</a></li>
            <li><a href=".artistsform" class="btn hoverbutton"  role="tab" data-toggle="tab">Καλλιτέχνης</a></li>
            <li><a href=".doctorsform" class="btn hoverbutton" role="tab" data-toggle="tab">Γιατρός</a></li>
            </ul>
...
<!-- Teachers Form -->
            <div class="tab-pane teachersform">
              ...
              <div class="container mtb">
           	 	<div class="row">
           <div class="col-lg-3">
                   <img src="img/portfolio/teacher1.jpg" alt="teachers" width = "100%">
           </div>
           	 		<div class="col-lg-9">
           	 			<h4 style = "color:#ffb726">Φόρμα Καταχώρησης Στοιχείων Εκπαιδευτικών</h4>
           	 			<div class="hline"></div>
           		 			<p>Παρακαλούμε εισάγετε τα στοιχεία σας όπως θέλετε να εμφανίζονται στις αναζητήσεις των επισκεπτών της σελίδας.
           		 			<br> Τα στοιχεία με * είναι υποχρεωτικά.</p>
           		 			<form role="form" action="beesProvider" method="post">

                       <div class="form-group">
                         <input type="hidden" name="category" value="Εκπαιδευτικός">
                     <label for="subcategory">Εκπαιδευτικός *</label>
                     <select class="form-control" name="subcategory" required>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         ...
                         <input type="text" class="form-control" name="service" placeholder="πχ. Ιδιαίτερα Λατινικών" required>
                       </div>
                       ...
                       <div class="form-group">
           					    <label for="price">Τιμή Υπηρεσίας *</label>
           					    <input type="number" class="form-control" name="price" placeholder="Σε ευρώ" required>
           					  </div>

                       <div class="form-group">
                     <label for="type">Κατηγορία Τιμής *</label>
                     ...
                     <select class="form-control" name="city" required>
                       ...
                       <div class="form-group">
                         <label for="pc">Ταχυδρομικός Κώδικας</label>
                       ...
                       <div class="form-group">
                         ...
                         <input type="text" class="form-control" name="phone" required>
           					  ...
           					  <div class="form-group">
           					    <label for="workemail">E-mail</label>
...
<!-- Workers Form -->
           ...
           <div class="col-lg-3">
                   <img src="img/portfolio/worker3.jpg" alt="workers" width = "100%">
           	 		...
           	 		<div class="col-lg-9">
           	 			<h4 style = "color:#ffb726">Φόρμα Καταχώρησης Στοιχείων Μαστόρων</h4>
           	 			<div class="hline"></div>
					<p>Παρακαλούμε εισάγετε τα στοιχεία σας όπως θέλετε να εμφανίζονται στις αναζητήσεις των επισκεπτών της σελίδας.
           		 			<br> Τα στοιχεία με * είναι υποχρεωτικά.</p>
           		 			
           		 			           		 			<form role="form" action="beesProvider" method="post"  oninput="x.value=parseInt(a.value)">

                       <div class="form-group">
                          <input type="hidden" name="category" value="Μάστορας">
                     <label for="subcategory">Μάστορας *</label>
                     <select class="form-control" name="subcategory" required>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         <label for="service">Υπηρεσία *</label>
                         <input type="text" class="form-control" name="service" placeholder="πχ. Εγκατάσταση Φωτιστικών" required>
                       </div>
...
<!-- Programmers Form ------------------------------------------------------------------------------------------------------------------>
           ...
           <div class="col-lg-3">
                   <img src="img/portfolio/programmer2.jpg" alt="programmers" width = "100%">

           </div>

                 <div class="col-lg-9">
                   <h4 style = "color:#ffb726">Φόρμα Καταχώρησης Στοιχείων Κομπιουτεράδων</h4>
                   <div class="hline"></div>
				<p>Παρακαλούμε εισάγετε τα στοιχεία σας όπως θέλετε να εμφανίζονται στις αναζητήσεις των επισκεπτών της σελίδας.
           		 			<br> Τα στοιχεία με * είναι υποχρεωτικά.</p>
           		 			                     <form role="form" action="beesProvider" method="post" oninput="x.value=parseInt(a.value)">
                       ...
                       <div class="form-group">
                     <label for="subcategory">Κομπιουτεράς *</label>
                     <select class="form-control" name="subcategory" required>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         <label for="service">Υπηρεσία *</label>
                         <input type="text" class="form-control" name="service" placeholder="πχ. Καθάρισμα από ιούς" required>
                       </div>
...
<!-- Artists Form ------------------------------------------------------------------------------------------------------------------------>
           ...
           <div class="col-lg-3">
                   <img src="img/portfolio/musician1.jpg" alt="artists" width = "100%">

           </div>

                 <div class="col-lg-9">
                   <h4 style = "color:#ffb726">Φόρμα Καταχώρησης Στοιχείων Καλλιτεχνών</h4>
                   <div class="hline"></div>
			<p>Παρακαλούμε εισάγετε τα στοιχεία σας όπως θέλετε να εμφανίζονται στις αναζητήσεις των επισκεπτών της σελίδας.
           		 			<br> Τα στοιχεία με * είναι υποχρεωτικά.</p>
           		 			                     <form role="form" action="beesProvider" method="post" oninput="x.value=parseInt(a.value)">
                       ...
                       <div class="form-group">
                     <label for="subcategory">Καλλιτέχνης *</label>
                     <select class="form-control" name="subcategory" required>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         <label for="service">Υπηρεσία *</label>
                         <input type="text" class="form-control" name="service" placeholder="πχ. Performance" required>
                       </div>
  ...
  <!-- Doctors Form -->
           ...
           <div class="col-lg-3">
                 ...
                 <div class="col-lg-9">
                   <h4 style = "color:#ffb726">Φόρμα Καταχώρησης Στοιχείων Γιατρών</h4>
                   <div class="hline"></div>
				<p>Παρακαλούμε εισάγετε τα στοιχεία σας όπως θέλετε να εμφανίζονται στις αναζητήσεις των επισκεπτών της σελίδας.
           		 			<br> Τα στοιχεία με * είναι υποχρεωτικά.</p>
           		 			                     <form role="form" action="beesProvider" method="post" oninput="x.value=parseInt(a.value)">
                       ...
                       <div class="form-group">
                     <label for="subcategory">Γιατρός *</label>
                     <select class="form-control" name="subcategory" required>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         <label for="service">Υπηρεσία *</label>
                         <input type="text" class="form-control" name="service" placeholder="πχ. Υπερηχογράφημα" required>
                       </div>
	 	...
	 	<div class="container">
            ...
            <a><i class="fa fa-linkedin"></i></a>
		 		...
		 		<div class="col-lg-4">
		 			...
		 			<div class="hline-w"></div>
		 			<p>
            <span class="glyphicon glyphicon glyphicon-earphone" aria-hidden="true"></span> &nbsp;  6972809585 <br>
            <span class="glyphicon glyphicon glyphicon-envelope" aria-hidden="true"></span> &nbsp;  <a href="mailto:busybees@outlook.com" target="_top">busybees@outlook.com</a><br>
            <span class="glyphicon glyphicon glyphicon-map-marker" aria-hidden="true"></span>  &nbsp; Ηρούς 4 & Κρέοντος 104 42, Αθήνα
