...
<div class="col-lg-3">
        <img src="img/portfolio/household2.jpg" alt="artists" width = "100%">
	 		...
	 		<div class="col-lg-9">
                ...
                %>
               <%@  
               page import="beesJava.Provider_job, beesDAO.Provider_jobDAO"
                %>
        ...
        <br>
		 			...
		 			<p>Παρακάτω μπορείτε να ελέγξετε τα στοιχεία που έχετε καταχωρήσει στο Busy Bees.</p>
		 			<p>Μπορείτε επίσης να διαγράψετε τις πληροφορίες που έχετε καταχωρήσει πατώντας εδώ:</p>
		 			
		 	
		 			
		 			<button type="submit" class="btn btn-logout" data-toggle="modal" data-target=".bs-modal-sm">Διαγραφή Δεδομένων</button>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form class="form-horizontal" action="deleteFromProvider" method="post">
            <fieldset> 
            
           <br>  
           <p><big>Είστε βέβαιοι ότι θέλετε να διαγράψετε όλα τα στοιχεία που έχετε καταχωρήσει στο Busy Bees;</big></p>      

             <center>
            <div class="control-group">
              <label class="control-label" for="signin"></label>
              <div class="controls">
                <button type="submit" id="signin" name="signin" class="btn btn-logout">Διαγραφή</button>            
             
        <button type="button" class="btn btn-theme" data-dismiss="modal">Ακύρωση</button>
         </div>
