	...
	<div class="container">
		...
		<div class="navbar-collapse collapse navbar-right">
			<ul class="nav navbar-nav">
				...
				<li><a href="" data-toggle="modal" data-target=".bs-modal-sm"><span
						class="glyphicon glyphicon-user" aria-hidden="true"> LOGIN</a></span></li>
...
<div class="modal fade bs-modal-sm" id="myModal" tabindex="-1"
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div style="background-color: #ffb726"
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="email" id="email" name="email"
											class="form-control" placeholder="youremail@email.com"
									...
									<div class="control-group">
										...
										<div class="controls">
											<button type="submit" id="signin" name="signin"
												class="btn btn-theme">Υποβολή</button>
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="username" name="username" class="form-control"
											type="text" placeholder="πχ stefanos27" class="input-large"
											required="">
									</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="password" name="password" class="form-control"
											...
											required=""> <em>Τουλάχιστον έξι χαρακτήρες</em>
									</div>
								</div>
								...
								<div class="radio">
									<label> <input type="radio" value="1"
										name="userCategory" id="userCategory" required> Είμαι
										<strong>Eπισκέπτης</strong> του Busy Bees
									</label>
								</div>

								<div class="radio">
									<label> <input type="radio" value="2"
										name="userCategory" id="userCategory"> Είμαι <strong>Επαγγελματίας</strong>
										που θέλω να προσφέρω τις υπηρεσίες μου στο Busy Bees
									</label>
								</div>
								<br>
