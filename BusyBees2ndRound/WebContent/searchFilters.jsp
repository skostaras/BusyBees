...
<div class="col-lg-3">
	<img src="img/mainlogo.png" class="img-responsive"> <br>

	<h4 style="color: #ffb726">Νέα Αναζήτηση με Φίλτρα</h4>
	<div class="hline"></div>
	<p>Περιηγηθείτε στους καταχωρημένους επαγγελματίες εφαρμόζοντας τα
		παρακάτω φίλτρα.</p>

	<form action="searchByFilterResults" method="post">

		<div class="form-group">
			<label for="category">Επάγγελμα</label> <select class="form-control"
		...
		<div id="Εκπαιδευτικός" class="inv">
			<div class="form-group">
				<label for="subcategory">Κατηγορία Επαγγέλματος</label> <select
					class="form-control" name="subcategory1">
		...
		<div id="Μάστορας" class="inv">
			<div class="form-group">
				<label for="subcategory">Κατηγορία Επαγγέλματος</label> <select
					class="form-control" name="subcategory2">
					<option value="%">Αδιάφορο</option>
		...
		<div id="Κομπιουτεράς" class="inv">
			<div class="form-group">
				<label for="subcategory">Κατηγορία Επαγγέλματος</label> <select
					class="form-control" name="subcategory3">
					<option value="%">Αδιάφορο</option>
		...
		<div id="Καλλιτέχνης" class="inv">
			<div class="form-group">
				<label for="subcategory">Κατηγορία Επαγγέλματος</label> <select
					class="form-control" name="subcategory4">
					<option value="%">Αδιάφορο</option>
		...
		<div id="Γιατρός" class="inv">
			<div class="form-group">
				<label for="subcategory">Κατηγορία Επαγγέλματος</label> <select
					class="form-control" name="subcategory5">
					<option value="%">Αδιάφορο</option>
		...
		<div class="form-group">
			<label for="city">Πόλη</label> <select class="form-control" id="city"
				name="city" required>
				<option value="%">Αδιάφορο</option>
		...
		<div class="form-group">
			<label for="servicekind">Κατηγορία Τιμής</label> <select
				class="form-control" id="servicekind" name="type" required>
				<option value="%">Αδιάφορο</option>
		...
		<div class="form-group">
			<label for="minMoney">Κατώτερη Τιμή</label> <input type="number"
				class="form-control" id="minMoney" name="minMoney" placeholder="Από"
				min="0" value="0"> <br> <label for="maxMoney">Μέγιστη
				Τιμή</label> <input type="number" class="form-control" id="maxMoney"
				name="maxMoney" placeholder="Έως" max="1000000" value="1000000">
		</div>
		...
		<br> <label><i>Να έχει απαραίτητα</i></label>
		<table title="ON: Να έχει απαραίτητα OFF: Αδιάφορο">
			<tr>
				...
				<td><label> &nbsp&nbsp&nbsp Τηλέφωνο</label></td>
			</tr>
			...
			<tr>
				<td><label class="switch"> <input type="checkbox"
						id="pageSlider" name="webpage" value="1">
						<div class="slider round"></div>
				</label></td>
				<td><label> &nbsp&nbsp&nbsp Ιστοσελίδα</label></td>
			</tr>
